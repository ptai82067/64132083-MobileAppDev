...
Button btnNext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        i = 0;
        list.add(new CauHoi("Trong C++, từ khóa nào được sử dụng để khai báo một lớp?", "class", "struct", "object", "function", "class"));
        list.add(new CauHoi("Trong C++, kiểu dữ liệu nào được dùng để lưu trữ số nguyên?", "float", "int", "double", "char", "int"));
        list.add(new CauHoi("Toán tử nào được sử dụng để truy cập thành viên của một lớp trong C++?", ".", "->", "::", "*", "->"));
        list.add(new CauHoi("Hàm nào trong C++ trả về số ký tự trong một chuỗi?", "strlen()", "sizeof()", "length()", "size()", "length()"));
        list.add(new CauHoi("Phương thức nào trong C++ được gọi khi một đối tượng bị hủy?", "constructor", "finalizer", "destructor", "deleter", "destructor"));
